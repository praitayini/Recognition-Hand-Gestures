...
class MyoRaw(object):
    ...
    def on_emg(self, emg, moving):
        # print('moving,emg',moving,emg)
        for h in self.emg_handlers:
            h(emg, moving)

    def on_imu(self, quat, acc, gyro):
        # print('quat',quat,'acc',acc,'gyo',gyro)
...
if  __name__ == '__main__':
    ...
    m.add_arm_handler(proc_arm) #lambda arm, xdir: print('arm', arm, 'xdir', xdir))
    m.add_pose_handler(proc_pose) #lambda p: print('pose', p))
